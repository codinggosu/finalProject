# Generated by Django 2.1.7 on 2019-06-07 11:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.TextField(null=True)),
                ('candidates', models.ManyToManyField(blank=True, to='catalog.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='Rate',
        ...
        migrations.AddField(
            ...
            name='user_from',
            field=models.ManyToManyField(related_name='user_from', to='catalog.Profile'),
        ),
        migrations.AddField(
            model_name='candidates2',
            name='user_to',
            field=models.ManyToManyField(related_name='user_to', to='catalog.Profile'),
        ),
    ]
